  ...
  const components = useMemo(() => {
    return {
      ...
      code({ className, children, ...props }: { className?: string; children: React.ReactNode; [key: string]: unknown }) {
        ...
        return (
          <code className={cn(className, "whitespace-pre-wrap text-secondary-foreground bg-secondary")} {...props}>
            {children}
          </code>
        );
      },
...
const MemoizedReactMarkdown: FC<Options & { className?: string }> = memo(
  ReactMarkdown,
  (prevProps: Options & { className?: string }, nextProps: Options & { className?: string }) =>
