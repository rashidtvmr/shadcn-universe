      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-8 border-t py-12 lg:grid-cols-5 lg:gap-4">
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-2xl font-bold">Anonumu</h2>
              </div>
            ...
            <p className="text-sm text-muted-foreground">
              Created with {`<3`} by avalynndev, and special thanks to Srinka
            </p>
          </div>

          <div>
            <p className="text-xs text-muted-foreground">
              Any data that is offensive or inappropriate can be reported and if
              found valid will be taken down.
            </p>
          </div>
        </div>
        ...
        <div className="col-span-2 grid grid-cols-3 gap-4">
          <Section.Root>
            ...
            <Section.List>
              <Section.Item>
                <Link href="mailto:avalynndev@gmail.com">Email</Link>
              </Section.Item>
            </Section.List>
          </Section.Root>

          <Section.Root>
            <Section.Label>Developer</Section.Label>
