...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay className={cn(twStyles.overlay, className)} {...props} ref={ref} />
))
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title ref={ref} className={cn(twStyles.title, className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Description ref={ref} className={cn(twStyles.description, className)} {...props} />
))
